...
import { useInspirationState } from '../hooks/useInspirationState';
...
export default function ChatPage() {
  // 既存フックを使用してステート管理を簡素化
  const chatState = useChatState();
  const inspirationState = useInspirationState();
  const uiState = useUIState();
  
  // useChatStateフックから全ての状態を取得
  const {
    message, setMessage,
    ...
    isImportExportOpen, setIsImportExportOpen,
  ...
  // useInspirationStateフックから状態を取得
  const {
    showInspiration, setShowInspiration,
    inspirationCandidates, setInspirationCandidates,
    showUserInspiration, setShowUserInspiration,
    userInspirationCandidates, setUserInspirationCandidates,
    showInspirationCandidates, setShowInspirationCandidates,
    isLoadingUserInspiration, setIsLoadingUserInspiration,
    isEnhancingUserText, setIsEnhancingUserText,
    sendButtonClicked, setSendButtonClicked,
    bulbButtonClicked, setBulbButtonClicked,
    sparkleButtonClicked, setSparkleButtonClicked
  } = inspirationState;
  
  // フックに含まれていない状態のみ個別定義
  const [isCharacterModalFromGallery, setIsCharacterModalFromGallery] = useState(false);
