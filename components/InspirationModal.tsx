          ...
          <div className="space-y-3 pb-4">
            {candidates.map((candidate, index) => (
              <button
                ...
                className="w-full p-3 md:p-4 text-left bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-lg border transition-colors min-h-[3rem] flex items-start focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-blue-50 dark:focus:bg-blue-900/30"
              >
